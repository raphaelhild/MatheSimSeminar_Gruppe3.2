...
public class Main extends JFrame {
	...
	public static void main(String[] args) {
		...
		int m2 = 1;
		int r1 = 30;
		AllCircles[0] = new Circle(150, 300, r1, 1, 0, m1);
		int r2 = 30;
		System.out.println("velocity x1 : " + AllCircles[0].velocity_x);
		AllCircles[1] = new Circle(300, 150, r2, 0, 1, m2);	
	...
	void draw() {
		...
		AllCircles[0].handleWallCollision(AllCircles[1]);
		AllCircles[1].handleWallCollision(AllCircles[0]);
